...
interface ApiResponse {
  name: string;
  timestamp: string; // Alterado para string, pois os dados de APIs geralmente retornam timestamps como strings.
}
    ...
    <Container tag="main">
      ...
      <Row>
        ...
        <Col>
          ...
          {clientSideData && (
            <h2>{new Date(clientSideData.timestamp).toDateString()}</h2>
          )}
        </Col>
      </Row>
    </Container>
